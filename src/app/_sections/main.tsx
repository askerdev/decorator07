...
export const MainSection = () => (
  <section className="relative -z-10 flex w-full flex-col items-center bg-[url('/images/hero_background.png')] bg-cover bg-center bg-no-repeat pb-[60px] after:absolute after:left-0 after:top-0 after:-z-10 after:h-full after:w-full after:bg-black after:opacity-60 after:content-[''] lg:pb-0">
    <Container>
      <Header />
        ...
        <div className="flex flex-col gap-8">
          <div className="flex max-w-[570px] flex-col gap-3 text-left">
            ...
            <p className="text-lg lg:text-xl">
              ...
              лепнины, а также помощь дизайнеров, чтобы создать интерьеры своей
              мечты
            </p>
          </div>
