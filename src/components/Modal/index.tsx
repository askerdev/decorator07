...
export const Modal = ({ className, trigger, rootProps, ...props }: Props) => (
  <Dialog.Root {...rootProps}>
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 flex w-full -translate-x-1/2 -translate-y-1/2 items-center justify-center",
          className,
        )}
        {...props}
      />
